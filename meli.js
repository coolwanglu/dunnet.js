...
var MELI = function () { 
    ...
    var Functions = { '*': function MULTIPLY(_, obj, scope) { 
            var r; var __frame = { name: 'MULTIPLY', line: 352 }; return __func(_, this, arguments, MULTIPLY, 0, __frame, function __$MULTIPLY() { r = 1; 
                ...
                return _list_for_each(__cb(_, __frame, 2, 0, function __$MULTIPLY() { 
                    ...
                    return _(null, r); }, true, false), obj, function __1(_, item) { var v; var __frame = { name: '__1', line: 354 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v = __1; assert(typeof v === 'number'); r *= v; _(); }, true, false), item, scope); }); }); }); }, '+': function PLUS(_, obj, scope) { 
            
            
            var r; var __frame = { name: 'PLUS', line: 362 }; return __func(_, this, arguments, PLUS, 0, __frame, function __$PLUS() { r = 0; 
                ...
                return _list_for_each(__cb(_, __frame, 2, 0, function __$PLUS() { 
                    ...
                    return _(null, r); }, true, false), obj, function __1(_, item) { var v; var __frame = { name: '__1', line: 364 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v = __1; assert(typeof v === 'number'); r += v; _(); }, true, false), item, scope); }); }); }); }, '-': function MINUS(_, obj, scope) { 
            
            
            var r, first; var __frame = { name: 'MINUS', line: 372 }; return __func(_, this, arguments, MINUS, 0, __frame, function __$MINUS() { r = 0; 
                first = true; 
                ...
                return _list_for_each(__cb(_, __frame, 3, 0, function __$MINUS() { 
                    ...
                    return _(null, r); }, true, false), obj, function __1(_, item) { var v; var __frame = { name: '__1', line: 375 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v = __1; assert(typeof v === 'number'); if (first) { first = false; r += v; } else { r -= v; } _(); }, true, false), item, scope); }); }); }); }, '1+': function ONEPLUS(_, obj, scope) { 
            
            
            var v; var __frame = { name: 'ONEPLUS', line: 386 }; return __func(_, this, arguments, ONEPLUS, 0, __frame, function __$ONEPLUS() { 
            ...
            var v1, v2; var __frame = { name: 'LESS_THAN', line: 392 }; return __func(_, this, arguments, LESS_THAN, 0, __frame, function __$LESS_THAN() { 
            ...
            var v1, v2; var __frame = { name: 'EQUAL', line: 401 }; return __func(_, this, arguments, EQUAL, 0, __frame, function __$EQUAL() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v1 = __1; 
                    assert(typeof v1 === 'number'); 
                    return _interpret(__cb(_, __frame, 3, 0, function ___(__0, __2) { v2 = __2; 
                        assert(typeof v2 === 'number'); 
            ...
            var v1, v2; var __frame = { name: 'GREATER_THAN', line: 409 }; return __func(_, this, arguments, GREATER_THAN, 0, __frame, function __$GREATER_THAN() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v1 = __1; 
                    assert(typeof v1 === 'number'); 
                    return _interpret(__cb(_, __frame, 3, 0, function ___(__0, __2) { v2 = __2; 
                        if (!(typeof v2 === 'number')) { console.log(v1, v2, obj); } 
            ...
            var v1, v2; var __frame = { name: 'GREATER_THAN_OR_EQUAL_TO', line: 418 }; return __func(_, this, arguments, GREATER_THAN_OR_EQUAL_TO, 0, __frame, function __$GREATER_THAN_OR_EQUAL_TO() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v1 = __1; 
                    assert(typeof v1 === 'number'); 
                    return _interpret(__cb(_, __frame, 3, 0, function ___(__0, __2) { v2 = __2; 
                        if (!(typeof v2 === 'number')) { console.log(v1, v2, obj); } 
            ...
            var v; var __frame = { name: 'abs', line: 427 }; return __func(_, this, arguments, abs, 0, __frame, function __$abs() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v = __1; 
                    assert(typeof v === 'number'); 
                    return _(null, Math.abs(v)); }, true, false), _car(obj), scope); }); }, and: function and(_, obj, scope) { 
            
            
            var r; var __frame = { name: 'and', line: 433 }; return __func(_, this, arguments, and, 0, __frame, function __$and() { r = 't'; 
            ...
            var l1, l2, l; var __frame = { name: 'append', line: 443 }; return __func(_, this, arguments, append, 0, __frame, function __$append() { 
            ...
            var a, i; var __frame = { name: 'aref', line: 455 }; return __func(_, this, arguments, aref, 0, __frame, function __$aref() { 
            ...
            var a, i, v; var __frame = { name: 'aset', line: 463 }; return __func(_, this, arguments, aset, 0, __frame, function __$aset() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { a = __1; 
            ...
            var k, l; var __frame = { name: 'assq', line: 473 }; return __func(_, this, arguments, assq, 0, __frame, function __$assq() { 
            ...
            var s; var __frame = { name: 'boundp', line: 485 }; return __func(_, this, arguments, boundp, 0, __frame, function __$boundp() { 
            ...
            var start, end; var __frame = { name: 'buffer_substring', line: 491 }; return __func(_, this, arguments, buffer_substring, 0, __frame, function __$buffer_substring() { 
            ...
            var l; var __frame = { name: 'car', line: 502 }; return __func(_, this, arguments, car, 0, __frame, function __$car() { 
            ...
            var l; var __frame = { name: 'cadr', line: 507 }; return __func(_, this, arguments, cadr, 0, __frame, function __$cadr() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { l = __1; 
                    return _(null, _car(_cdr(l))); }, true, false), _car(obj), scope); }); }, cdr: function cdr(_, obj, scope) { 
            
            
            var l; var __frame = { name: 'cdr', line: 512 }; return __func(_, this, arguments, cdr, 0, __frame, function __$cdr() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { l = __1; 
                    return _(null, _cdr(l)); }, true, false), _car(obj), scope); }); }, concat: function concat(_, obj, scope) { 
            
            
            var r; var __frame = { name: 'concat', line: 517 }; return __func(_, this, arguments, concat, 0, __frame, function __$concat() { r = []; 
                ...
                return _list_for_each(__cb(_, __frame, 2, 0, function __$concat() { 
                    ...
                    var v; var __frame = { name: '__1', line: 519 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v = __1; assert(v.type === 'string'); r = r.concat(v.value); _(); }, true, false), item, scope); }); }); }); }, cond: function cond(_, obj, scope) { 
            
            
            
            var result, clause; var __frame = { name: 'cond', line: 530 }; return __func(_, this, arguments, cond, 0, __frame, function __$cond() { result = []; 
            ...
            var r; var __frame = { name: 'condition_case', line: 548 }; return __func(_, this, arguments, condition_case, 0, __frame, function __$condition_case() { 
            ...
            var __frame = { name: 'current_buffer', line: 561 }; return __func(_, this, arguments, current_buffer, 0, __frame, function __$current_buffer() { 
                return _(null, _cur_buffer); }); }, 'current-time-string': function current_time_string(_, obj, scope) { 
            
            
            var now; 
            
            function to_2s(v) { return (v < 10 ? '0' : '') + v; } var __frame = { name: 'current_time_string', line: 565 }; return __func(_, this, arguments, current_time_string, 0, __frame, function __$current_time_string() { now = new Date(); 
            ...
            var __frame = { name: 'DEBUG', line: 582 }; return __func(_, this, arguments, DEBUG, 0, __frame, function __$DEBUG() { 
            ...
            var sym; var __frame = { name: 'defconst', line: 586 }; return __func(_, this, arguments, defconst, 0, __frame, function __$defconst() { sym = _car(obj); 
            ...
            var sym; var __frame = { name: 'defcustom', line: 592 }; return __func(_, this, arguments, defcustom, 0, __frame, function __$defcustom() { sym = _car(obj); 
                
                return _interpret(__cb(_, __frame, 2, 0, function ___(__0, __1) { Global.set(sym, __1); 
                    return _(null, sym); }, true, false), _cadr(obj), scope); }); }, 'define-key': function define_key(_, obj, scope) { 
            
            
            var km, key, def, l, entry; var __frame = { name: 'define_key', line: 598 }; return __func(_, this, arguments, define_key, 0, __frame, function __$define_key() { 
            ...
            var __frame = { name: 'defgroup', line: 628 }; return __func(_, this, arguments, defgroup, 0, __frame, function __$defgroup() { return _(null, []); }); }, defun: function defun(_, obj, scope) { 
            
            var name, func; var __frame = { name: 'defun', line: 630 }; return __func(_, this, arguments, defun, 0, __frame, function __$defun() { name = _car(obj); 
            ...
            var sym; var __frame = { name: 'defvar', line: 642 }; return __func(_, this, arguments, defvar, 0, __frame, function __$defvar() { sym = _car(obj); 
                
                return _interpret(__cb(_, __frame, 2, 0, function ___(__0, __1) { Global.set(sym, __1); 
                    return _(null, sym); }, true, false), _cadr(obj), scope); }); }, 'delete-file': function delete_file(_, obj, scope) { 
            
            
            var fn; var __frame = { name: 'delete_file', line: 648 }; return __func(_, this, arguments, delete_file, 0, __frame, function __$delete_file() { 
            ...
            var arg, v, list, s; var __frame = { name: 'dolist', line: 658 }; return __func(_, this, arguments, dolist, 0, __frame, function __$dolist() { arg = _car(obj); 
                ...
                return _interpret(__cb(_, __frame, 5, 0, function ___(__0, __2) { list = __2; 
                    ...
                    return _list_for_each(__cb(_, __frame, 9, 0, function __$dolist() { 
                        ...
                        return _(null, s.get(_cadr(_cdr(arg)))); }, true, false), list, function __1(_, item) { var __frame = { name: '__1', line: 667 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { s.set(v, item); return _list_for_each(__cb(_, __frame, 2, 0, function __$__1() { _(); }, true, false), _cdr(obj), function __1(_, item) { var __frame = { name: '__1', line: 669 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function __$__1() { _(); }, true, false), item, s); }); }); }); }); }, true, false), _cadr(arg), scope); }); }, downcase: function downcase(_, obj, scope) { 
            
            
            var v; var __frame = { name: 'downcase', line: 676 }; return __func(_, this, arguments, downcase, 0, __frame, function __$downcase() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v = __1; 
            ...
            var v1, v2; var __frame = { name: 'eq', line: 691 }; return __func(_, this, arguments, eq, 0, __frame, function __$eq() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v1 = __1; 
            ...
            var __frame = { name: 'erase_buffer', line: 697 }; return __func(_, this, arguments, erase_buffer, 0, __frame, function __$erase_buffer() { 
                _cur_buffer.value = []; 
                return _(null, []); }); }, eval: function eval(_, obj, scope) { 
            
            
            var __frame = { name: 'eval', line: 702 }; return __func(_, this, arguments, eval, 0, __frame, function __$eval() { 
            ...
            var __frame = { name: 'eval_and_compile', line: 706 }; return __func(_, this, arguments, eval_and_compile, 0, __frame, function __$eval_and_compile() { return _(null, []); }); }, 'eval-current-buffer': function eval_current_buffer(_, obj, scope) { 
            
            var __frame = { name: 'eval_current_buffer', line: 708 }; return __func(_, this, arguments, eval_current_buffer, 0, __frame, function __$eval_current_buffer() { 
            ...
            var __frame = { name: 'eval_when_compile', line: 712 }; return __func(_, this, arguments, eval_when_compile, 0, __frame, function __$eval_when_compile() { return _(null, []); }); }, 'file-exists-p': function file_exists_p(_, obj, scope) { 
            
            var fn, data; var __frame = { name: 'file_exists_p', line: 714 }; return __func(_, this, arguments, file_exists_p, 0, __frame, function __$file_exists_p() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { fn = __1; 
                    assert(fn.type === 'string'); 
                    fn = _array_to_string(fn.value); 
            ...
            var fn, fn2; var __frame = { name: 'fset', line: 727 }; return __func(_, this, arguments, fset, 0, __frame, function __$fset() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { fn = __1; 
            ...
            var s; var __frame = { name: 'get_buffer_create', line: 737 }; return __func(_, this, arguments, get_buffer_create, 0, __frame, function __$get_buffer_create() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { s = __1; 
            ...
            var __frame = { name: 'goto_char', line: 743 }; return __func(_, this, arguments, goto_char, 0, __frame, function __$goto_char() { return _(null, []); }); }, if: function IF(_, obj, scope) { 
            
            var r; var __frame = { name: 'IF', line: 745 }; return __func(_, this, arguments, IF, 0, __frame, function __$IF() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __3) { var __2 = _is_nil(__3); return function __$IF(__then) { if (__2) { r = []; 
                            ...
                            return _list_for_each(__cb(_, __frame, 3, 0, function __$IF() { 
                                ...
                                return _(null, r); }, true, false), _cddr(obj), function __1(_, item) { var __frame = { name: '__1', line: 748 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { r = __1; _(); }, true, false), item, scope); }); }); } else { 
            ...
            var s; var __frame = { name: 'insert', line: 757 }; return __func(_, this, arguments, insert, 0, __frame, function __$insert() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { s = __1; 
                    assert(s.type === 'string'); 
            ...
            var fn, data; var __frame = { name: 'insert_file_contents', line: 764 }; return __func(_, this, arguments, insert_file_contents, 0, __frame, function __$insert_file_contents() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { fn = __1; 
                    assert(fn.type === 'string'); 
            ...
            var __frame = { name: 'interactive', line: 778 }; return __func(_, this, arguments, interactive, 0, __frame, function __$interactive() { return _(null, []); }); }, intern: function intern(_, obj, scope) { 
            
            var s; var __frame = { name: 'intern', line: 780 }; return __func(_, this, arguments, intern, 0, __frame, function __$intern() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { s = __1; 
                    assert(s.type === 'string'); 
                    return _(null, _array_to_string(s.value)); }, true, false), _car(obj), scope); }); }, 'kill-buffer': function kill_buffer(_, obj, scope) { 
            
            
            var b, r; var __frame = { name: 'kill_buffer', line: 786 }; return __func(_, this, arguments, kill_buffer, 0, __frame, function __$kill_buffer() { 
            ...
            var s, l; var __frame = { name: 'length', line: 799 }; return __func(_, this, arguments, length, 0, __frame, function __$length() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { s = __1; 
            ...
            var let_scope, r; var __frame = { name: 'LET', line: 813 }; return __func(_, this, arguments, LET, 0, __frame, function __$LET() { let_scope = new Scope(scope); 
                ...
                return _list_for_each(__cb(_, __frame, 2, 0, function __$LET() { r = []; 
                    ...
                    return _list_for_each(__cb(_, __frame, 7, 0, function __$LET() { 
                        ...
                        return _(null, r); }, true, false), _cdr(obj), function __2(_, item) { var __frame = { name: '__2', line: 820 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { r = __1; _(); }, true, false), item, let_scope); }); }); }, true, false), _car(obj), function __1(_, item) { var __frame = { name: '__1', line: 815 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return function __$__1(__then) { if (typeof item === 'string') { let_scope.set(item, []); __then(); } else { return _interpret(__cb(_, __frame, 2, 0, function ___(__0, __1) { let_scope.set(_car(item), __1); __then(); }, true, false), _cadr(item), let_scope); } }(_); }); }); }); }, list: function list(_, obj, scope) { 
            
            
            var result, l; var __frame = { name: 'list', line: 826 }; return __func(_, this, arguments, list, 0, __frame, function __$list() { result = []; 
                l = result; 
                ...
                return _list_for_each(__cb(_, __frame, 3, 0, function __$list() { 
                    ...
                    return _(null, result); }, true, false), obj, function __1(_, item) { var __frame = { name: '__1', line: 829 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { l.push(__1, []); l = l[1]; _(); }, true, false), item, scope); }); }); }); }, listp: function listp(_, obj, scope) { 
            
            
            var l; var __frame = { name: 'listp', line: 836 }; return __func(_, this, arguments, listp, 0, __frame, function __$listp() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { l = __1; 
                    return _(null, l instanceof Array ? 't' : []); }, true, false), _car(obj), scope); }); }, 'make-sparse-keymap': function make_sparse_keymap(_, obj, scope) { 
            
            
            var __frame = { name: 'make_sparse_keymap', line: 841 }; return __func(_, this, arguments, make_sparse_keymap, 0, __frame, function __$make_sparse_keymap() { 
                return _(null, [ 'keymap', [] ]); }); }, 'make-keymap': function make_keymap(_, obj, scope) { 
            
            
            var km, i; var __frame = { name: 'make_keymap', line: 845 }; return __func(_, this, arguments, make_keymap, 0, __frame, function __$make_keymap() { km = []; 
            ...
            var r, len, o, i; var __frame = { name: 'make_vector', line: 855 }; return __func(_, this, arguments, make_vector, 0, __frame, function __$make_vector() { r = []; 
            ...
            var e, l; var __frame = { name: 'member', line: 868 }; return __func(_, this, arguments, member, 0, __frame, function __$member() { 
            ...
            var __frame = { name: 'not', line: 879 }; return __func(_, this, arguments, not, 0, __frame, function __$not() { 
            ...
            var n, l, i; var __frame = { name: 'nth', line: 883 }; return __func(_, this, arguments, nth, 0, __frame, function __$nth() { 
            ...
            var n, l, i; var __frame = { name: 'nthcdr', line: 895 }; return __func(_, this, arguments, nthcdr, 0, __frame, function __$nthcdr() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { n = __1; 
                    assert(typeof n === 'number'); 
                    return _interpret(__cb(_, __frame, 3, 0, function ___(__0, __2) { l = __2; 
                        assert(l instanceof Array); 
            ...
            var r; var __frame = { name: 'or', line: 907 }; return __func(_, this, arguments, or, 0, __frame, function __$or() { 
            ...
            var __frame = { name: 'point_min', line: 916 }; return __func(_, this, arguments, point_min, 0, __frame, function __$point_min() { 
                return _(null, 1); }); }, 'point-max': function point_max(_, obj, scope) { 
            
            
            var __frame = { name: 'point_max', line: 920 }; return __func(_, this, arguments, point_max, 0, __frame, function __$point_max() { 
                return _(null, 1 + _cur_buffer.value.length); }); }, 'prin1-to-string': function prin1_to_string(_, obj, scope) { 
            
            
            var v; var __frame = { name: 'prin1_to_string', line: 924 }; return __func(_, this, arguments, prin1_to_string, 0, __frame, function __$prin1_to_string() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v = __1; 
            ...
            var o; var __frame = { name: 'princ', line: 932 }; return __func(_, this, arguments, princ, 0, __frame, function __$princ() { 
            ...
            var r; var __frame = { name: 'progn', line: 938 }; return __func(_, this, arguments, progn, 0, __frame, function __$progn() { r = []; 
                
                return _list_for_each(__cb(_, __frame, 2, 0, function __$progn() { 
                    
                    
                    return _(null, r); }, true, false), obj, function __1(_, item) { var __frame = { name: '__1', line: 940 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { r = __1; _(); }, true, false), item, scope); }); }); }); }, provide: function provide(_) { 
            
            
            var __frame = { name: 'provide', line: 946 }; return __func(_, this, arguments, provide, 0, __frame, function __$provide() { return _(null, []); }); }, quote: function quote(_, obj, scope) { 
            
            var __frame = { name: 'quote', line: 948 }; return __func(_, this, arguments, quote, 0, __frame, function __$quote() { 
                return _(null, _car(obj)); }); }, random: function random(_, obj, scope) { 
            
            
            var n, N; var __frame = { name: 'random', line: 952 }; return __func(_, this, arguments, random, 0, __frame, function __$random() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { n = __1; 
            ...
            var prmpt, init, keymap, line; var __frame = { name: 'read_from_minibuffer', line: 959 }; return __func(_, this, arguments, read_from_minibuffer, 0, __frame, function __$read_from_minibuffer() { 
                        ...
                        return _interpret(__cb(_, __frame, 6, 0, function ___(__0, __3) { keymap = __3; 
                            ...
                            return function (callback) { 
                                _readline(function (input) { 
                                    callback(null, input); }); }(__cb(_, __frame, 8, 0, function ___(__0, __4) { line = __4; 
                                
                                
                                _print(line + '\n'); 
                                return _(null, { type: 'string', value: _string_to_array(line) }); }, true, false)); }, true, false), _car(_cddr(obj)), scope); }, true, false), _cadr(obj), scope); }, true, false), _car(obj), scope); }); }, require: function require(_) { 
            
            
            var __frame = { name: 'require', line: 976 }; return __func(_, this, arguments, require, 0, __frame, function __$require() { return _(null, []); }); }, rplaca: function rplaca(_, obj, scope) { 
            
            var l, newcar; var __frame = { name: 'rplaca', line: 978 }; return __func(_, this, arguments, rplaca, 0, __frame, function __$rplaca() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { l = __1; 
                    assert(l instanceof Array); 
            ...
            var s; var __frame = { name: 'send_string_to_terminal', line: 986 }; return __func(_, this, arguments, send_string_to_terminal, 0, __frame, function __$send_string_to_terminal() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { s = __1; 
                    assert(s.type === 'string'); 
            ...
            var sym, s, r; var __frame = { name: 'setq', line: 993 }; return __func(_, this, arguments, setq, 0, __frame, function __$setq() { sym = _car(obj); 
            ...
            var s; var __frame = { name: 'sleep_for', line: 1001 }; return __func(_, this, arguments, sleep_for, 0, __frame, function __$sleep_for() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { s = __1; 
            ...
            var regexp, s, idx; var __frame = { name: 'string_match', line: 1008 }; return __func(_, this, arguments, string_match, 0, __frame, function __$string_match() { 
            ...
            var v1, v2; var __frame = { name: 'string_EQUAL_TO', line: 1019 }; return __func(_, this, arguments, string_EQUAL_TO, 0, __frame, function __$string_EQUAL_TO() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v1 = __1; 
            ...
            var s; var __frame = { name: 'stringp', line: 1029 }; return __func(_, this, arguments, stringp, 0, __frame, function __$stringp() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { s = __1; 
                    return _(null, s.type === 'string' ? 't' : []); }, true, false), _car(obj), scope); }); }, substring: function substring(_, obj, scope) { 
            
            
            var v1, v2, v3; var __frame = { name: 'substring', line: 1034 }; return __func(_, this, arguments, substring, 0, __frame, function __$substring() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v1 = __1; 
            ...
            var s; var __frame = { name: 'switch_to_buffer', line: 1048 }; return __func(_, this, arguments, switch_to_buffer, 0, __frame, function __$switch_to_buffer() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { s = __1; 
            ...
            var s; var __frame = { name: 'symbolp', line: 1056 }; return __func(_, this, arguments, symbolp, 0, __frame, function __$symbolp() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { s = __1; 
                    return _(null, typeof s === 'string' ? 't' : []); }, true, false), _car(obj), scope); }); }, unless: function unless(_, obj, scope) { 
            
            
            var r; var __frame = { name: 'unless', line: 1061 }; return __func(_, this, arguments, unless, 0, __frame, function __$unless() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __3) { var __2 = _is_nil(__3); return function __$unless(__then) { if (__2) { r = []; 
                            ...
                            return _list_for_each(__cb(_, __frame, 3, 0, function __$unless() { 
                                ...
                                return _(null, r); }, true, false), _cdr(obj), function __1(_, item) { var __frame = { name: '__1', line: 1064 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { r = __1; _(); }, true, false), item, scope); }); }); } else { 
                            
                            return _(null, []); } }(_); }, true, false), _car(obj), scope); }); }, upcase: function upcase(_, obj, scope) { 
            
            
            
            var v; var __frame = { name: 'upcase', line: 1073 }; return __func(_, this, arguments, upcase, 0, __frame, function __$upcase() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { v = __1; 
                    assert(typeof v === 'number' || v.type === 'string'); 
                    if (v.type === 'string') { 
                        return _(null, { type: 'string', value: v.value.map(function (v) { 
            ...
            var __frame = { name: 'user_login_name', line: 1088 }; return __func(_, this, arguments, user_login_name, 0, __frame, function __$user_login_name() { 
                return _(null, { type: 'string', value: _string_to_array('root') }); }); }, when: function when(_, obj, scope) { 
            
            
            var r; var __frame = { name: 'when', line: 1092 }; return __func(_, this, arguments, when, 0, __frame, function __$when() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __3) { var __2 = !_is_nil(__3); return function __$when(__then) { if (__2) { r = []; 
                            ...
                            return _list_for_each(__cb(_, __frame, 3, 0, function __$when() { 
                                ...
                                return _(null, r); }, true, false), _cdr(obj), function __1(_, item) { var __frame = { name: '__1', line: 1095 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { r = __1; _(); }, true, false), item, scope); }); }); } else { 
                            
                            return _(null, []); } }(_); }, true, false), _car(obj), scope); }); }, while: function WHILE(_, obj, scope) { 
            
            
            
            var r; var __frame = { name: 'WHILE', line: 1104 }; return __func(_, this, arguments, WHILE, 0, __frame, function __$WHILE() { r = []; 
                ...
                return function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$WHILE() { __more = false; return function __$WHILE(_) { return _interpret(__cb(_, __frame, 2, 0, function ___(__0, __3) { var __2 = !_is_nil(__3); return _(null, __2); }, true, false), _car(obj), scope); }(__cb(_, __frame, 2, 0, function ___(__0, __2) { if (__2) { 
                                return _list_for_each(__cb(_, __frame, 3, 0, function __$WHILE() { while (__more) { __loop(); } __more = true; }, true, false), _cdr(obj), function __1(_, item) { var __frame = { name: '__1', line: 1107 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { 
            ...
            var start, end, fn, append; var __frame = { name: 'write_region', line: 1114 }; return __func(_, this, arguments, write_region, 0, __frame, function __$write_region() { 
                return _interpret(__cb(_, __frame, 1, 0, function ___(__0, __1) { start = __1; 
                    assert(typeof start === 'number'); 
                    return _interpret(__cb(_, __frame, 3, 0, function ___(__0, __2) { end = __2; 
                        assert(typeof end === 'number'); 
            ...
            var __frame = { name: 'yow', line: 1130 }; return __func(_, this, arguments, yow, 0, __frame, function __$yow() { 
    ...
    return { eval: function eval(input, options) { 
            ...
            _interpret(function (ex, ret) { 
                if (ex) { 
                    ...
                    console.log(ex.message); 
                    console.log(ex.stack); } else if (options.exit) { 
                    
                    options.exit(ret); } }, new Parser(input).tokenize(), Global); }, scan_missing: function scan_missing(input, ignore_func) { 
